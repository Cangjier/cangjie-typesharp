...
public class MimeTypes:IEnumerable<MimeType>,IReleasable
{
    public static Template<char> MimeTypeTemplate { get; } = new Func<Template<char>>(() =>
    {
        ...
        result.ReorganizationTemplate.Ban(
            Statement.Reorganization.Instance,
            Statement.Reorganization2.Instance,
            Statement.Reorganization3.Instance,
            TypeDefine.Reorganization.Instance);
        return result;
    })();
