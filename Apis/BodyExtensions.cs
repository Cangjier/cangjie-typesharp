...
public static class BodyExtensions
{
    ...
    public static bool IsFormDataBody(this Json self)
    {
        if (self.IsArray == false) return false;
        return self.All(item => item.IsObject && item.ContainsKey("Type"));
    }
